...
describe("ReadStep — preview reframed as teaser for the PDF", () => {
  ...
  it("shows the full content once the pretest is done", () => {
    renderRead({ pretestDone: true });
  ...
  it("omits the PDF link when no moduleId is supplied", () => {
    renderRead({ moduleId: undefined, pretestDone: false });
